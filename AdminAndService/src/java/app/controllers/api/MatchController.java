...
import static app.controllers.api.ClubController.URL_CLUB;
...
public class MatchController extends HttpServlet {
    ...
    public static final String URL_MATCH = "http://long-victor-105516.appspot.com/api/matches/";
    /**
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(apikey != null){
              if(APIManager.getInstance().checkApiKey(apikey)) {
                  handlApi(league, mode, request, response);
             }
        }
     
    }
   
  protected void handlApi(String league,String mode,HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
